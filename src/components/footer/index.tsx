...
const socials = [
  {
    ...
    link: "https://www.facebook.com/Spacemediaproduction.co",
  },
  {
    icon: (
      <svg
    ...
    link: "https://www.instagram.com/space_media_production",
  },
  {
    icon: (
      <svg
    ...
    link: "https://www.tiktok.com/@spacemediaproduction",
  },
];
          ...
          >
            <div className="mb-4 sm:mb-0 space-y-5">
              ...
              <p className="flex items-center gap-2 text-sm">
                <Mail size={16} />
                <a
                  href="mailto:hello@spacemediaproduction.com?subject=Hello%spacemedia&body=I%20would%20like%20to%20inquire%20about%20your%20services."
                  className="hover:text-brand_primary transition-all"
                >
                  hello@spacemediaproduction.com
                </a>
              </p>
              <p className="flex items-center gap-2 text-sm">
                <Phone size={16} />
